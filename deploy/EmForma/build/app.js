...
enyo.path.addPaths({layout: "/Users/soapdog/PhpstormProjects/EmForma/enyo/../lib/layout/", onyx: "/Users/soapdog/PhpstormProjects/EmForma/enyo/../lib/onyx/", onyx: "/Users/soapdog/PhpstormProjects/EmForma/enyo/../lib/onyx/source/"});
...
statics: {
set: function(e, t) {
typeof e == "string" && (typeof t == "object" ? localStorage.setItem(e, JSON.stringify(t)) : typeof t == "string" ? localStorage.setItem(e, t) : typeof t == "number" && localStorage.setItem(e, t.toString()));
},
get: function(e, t) {
var n;
typeof e == "string" && (n = localStorage.getItem(e));
if (typeof n == "string") return JSON.parse(n);
if (typeof n == "object" && n !== null) throw enyo.log("OBJECT: " + n), "ERROR [Storage.get]: getItem returned an object. Should be a string.";
if (typeof n == "undefined" || n === null) return t;
},
remove: function(e) {
...
this.log("Storing geo object:"), console.log(e);
var t = this.numLocations(), n = "geo_" + t;
this.log("key:" + n), Storage.set(n, e);
},
getLocations: function() {
this.log("Retrieving all geo locations");
var e = new Array;
for (var t = 0; t < this.numLocations() - 1; t++) {
var n = "geo_" + t;
e[t] = Storage.get(n);
}
return e;
},
eraseAllSavedLocations: function() {
for (var e in localStorage) Storage.remove(e);
}
});
...
kind: "enyo.Component",
statics: {
getHumanReadableAchievements: function() {
var e = [ "Voc\u00ea correu 32km ao todo.", "Sua velocidade m\u00e1xima foi 2km/h", "Voc\u00ea e seus amigos juntos correram 300km!!! Parab\u00e9ns!", "Voc\u00ea corre 3 vezes por semana.", "Voc\u00ea praticou esportes 3 dias seguidos." ];
return e;
}
}
});
...
taglines: [ "De o primeiro passo!", "Corra como se n\u00e3o houvesse amanh\u00e3!", "Esquece o celular e va correr!" ]
}, {
kind: "enyo.Scroller",
fit: !0,
components: [ {
kind: "Repeater",
count: AchievementsModel.getHumanReadableAchievements().length,
components: [ {
style: "color: grey; padding: 10px; font-size: 1.1em;",
components: [ {
tag: "span",
content: "&rarr;&nbsp;&nbsp;",
allowHtml: !0
...
var n = t.item, r = AchievementsModel.getHumanReadableAchievements();
return n.$.text.setContent(r[t.index]), !0;
},
...
this.log("Saving..."), this.$.db.saveLocation(n), this.log("Batch Saving...");
for (var r = 0; r < 10; r++) this.$.db.saveLocation(n);
this.log("How many records:" + this.$.db.numLocations()), this.log("Get Locations...");
var i = this.$.db.getLocations();
console.log(i), this.log("Deleting everyting..."), this.$.db.eraseAllSavedLocations(), this.log("How many records:" + this.$.db.numLocations());
var s = this.$.db.numLocations();
console.log(s), console.log(typeof s);
}
});
